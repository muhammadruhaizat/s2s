				  ...
				  <table width=100% border="0" align="center" style="height:100%;">
				    <tr>
				      <td align="left" valign="middle">
				        ...
				        <li class="red"> <a href="<?php echo base_url();?>query"><br/><i class="ace-icon fa fa-search" style="font-size:2.5em !important;"></i><br/><span class="badge badge-grey">Carian</span> </a> </li>
